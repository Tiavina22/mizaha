...
<body>
   ...
   <div class="headerApp">
      ...
      <div class="left">
         <div class="leftTop">
            <div class="btn">
               ...
               <a href="../app/homeApp.php" class="bindAccueil" style="color:#CECECE;">Accueil</a>
            </div>
            <div class="btn">
               <i class="fa fa-search fa-2x"></i>
               <a href="../app/rechercheApp.php" class="bindRecherche" style="color:white;font-family: poppinsBold;border-bottom: 4px solid #1ED760;">Recherche</a>
            </div>
            </div>
         <div class="leftFoot">
            <div>
               <div class="btn">
                  ...
                  <a href="../app/endroitsApp.php" class="bindEndroits" style="margin-left: 40px;">Endroits touristiques</a>
               </div>
               <div class="btn">
                  <i class="fa fa-hotel fa-2x"></i>
                  <a href="../app/hotelsApp.php" class="bindHotels" style="margin-left: 26px;">Hôtels</a>
               </div>
               <div class="btn">
                  <i class="fa fa-truck fa-2x"></i>
                  <a href="../app/transportApps.php" class="bindTransport" style="margin-left: 29px;">Agence de transport</a>
               </div>
               <div class="btn">
                  <i class="fa fa-user-secret fa-2x" style="margin-left: 5px;"></i>
                  <a href="../app/guidesApp.php" style="margin-left: 28px;" class="bindGuides">Guides</a>
               </div>
            </div>
            ...
            <div class="buttonLanguage" style="cursor:pointer;" title="Seulement la Français est disponnible">
               <i class="fa fa-globe fa-2x"></i>
               <a href="app/languageApp.php" style="cursor:pointer;">Français</a>
            </div>
         </div>
      </div>
      <!-- left header de l'application -->
	...
	//requete sql pour faire la recherche
	$sql = "SELECT * FROM endroits WHERE nom LIKE '%$searchTerm%' OR id LIKE '%$searchTerm%' OR type LIKE '%$searchTerm%' OR region LIKE '%$searchTerm%' OR description LIKE '%$searchTerm%'";
	...
	if($resultat->num_rows > 0){
		echo "<h1 style='font-size:20px;margin-left:85px;'>Résultat de la recherche qui contient le mot ' $searchTerm '</h1><br>";
		//parcours des résultats et affichages
		echo "<div style='display:flex;flex-direction:row;flex-wrap: wrap;margin-top:-15px;margin-left:55px;padding-bottom:10px;' class='block'>";
		while ($row = $resultat->fetch_assoc()){
			$endroitId = $row['id'];
			$description = $row['description'];
			$descriptionShort = implode(' ', array_slice(explode(' ', $description), 0, 10)) . " ...";
			$photoPrincipales = $row['photo_principale'];
			echo "<a href='../app/endroitsDetails.php?id=$endroitId' style='text-decoration:none;'>";
			echo '<div class="cardview" style="width:150px;position:relative;margin-bottom:100px;margin-left:15px;background-color:#181818;border-radius:15px;height:245px;padding:10px;margin-top:0px;">';
			echo '<img  src="' . $photoPrincipales . '" style="width:98%;height:130px;object-fit:cover;border-radius:10px;margin-bottom:10px;">';
			echo '<h3 style="margin:0;font-size:13px;font-family:poppinsBold;">'. $row['nom'] . '</h3>';
      ...
      $mTop = "200px";
		echo '<h1 style="color:white;font-size:20px;margin-left:75px;">Aucun résultat trouvé</h1>';
		//echo '<script>alert("Hello");</script>';
	}
	
	$conn->close();
?>
<div class="endroitPopulaire" id="started" style="margin-top:-40px;margin-left: 25px; font-family:">
                <h1 style='font-size:20px;margin-left:35px;margin-top: 50px;'>Les 5 endroits le plus recherchées</h1>
...
//connexion à la base de donnée
   ...
   if ($resultat->num_rows > 0) {
      ...
      while ($row = $resultat->fetch_assoc()){
         ...
         echo "<a href='../app/endroitsDetails.php?id=$endroitId' class='endroit-card' style='width:16%;margin-left:5px;background-color:#181818;border-radius:15px;padding:10px;margin-top:10px;'>";
         echo '<div>';
      ...
      <!-- right Top de l'application -->
         <div class="rightApp">
            ...
            <div class="budgetSection" style="display: flex;flex-direction: column;">
               ...
               <a class="btn_budget" href="../app/budgetApp.php">Créer une budget</a>
            </div>
