<?php
	...
	$sql = "INSERT INTO hotels (nom,type,region,adresse,description, photo_principale, photo_supplementaire) VALUES ('$nom', '$type', '$region', '$adresse', '$description', '$photoPrincipaleDestination', '" . implode(",", $imageNoms) . "')";
