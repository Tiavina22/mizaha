...
<body>
	<div style="display:flex;flex-direction:row;justify-content: space-between;align-items: center;">
		<div style="display:flex;flex-direction:row;align-items: center;">
			...
			<p style="margin-left:10px;font-family: poppinsBold;">Mizaha Transport</p>
		</div>
		<div style="display:flex;flex-direction:row;align-items: center;">
			<?php
			...
			$sql = "SELECT nom FROM transports WHERE id = $id";
			$resultat = $conn->query($sql);
			$row = $resultat->fetch_assoc();
			$nomTransport = $row['nom'];

			?>
			<button onclick="alert('Réservation éffectuer de place <?php echo "$nomTransport"; ?>')" style="background-color:#1ED760;border: none;color: white;border-radius: 15px;padding: 10px;font-size:14px;cursor:pointer;width: 100px;font-family: poppinsBold;box-shadow: 0 0 10px rgba(0, 0, 0, 0.3);">Réserver</button>
	...
	<div style="display:flex;flex-direction: row;width: 100%;margin-top: 20px;">
		<div style="display:flex;flex-direction: row;width: 40%;">
			...
			<div style="margin-left:25px;display: flex;flex-direction: column;padding-bottom:35px;padding-top:35px;justify-content: space-between;">
				<?php 
					echo '<h3> Destination : ' . $destination . '</h3><br>';
		...
		<div style="width:60%;">
			<h1>Description de l'agence de transport</h1>
        ...
        <form action="" style="color:black;">
            ...
            <label for="" style="color:black;">Type de voiture</label><br>
            <select id="selectRoom" name="" id="" style="color:black;background-color:white;padding:10px;">
                <option value="famille">Lite (40.000 MGA/J)</option>
                <option value="couple">Premium(60.000 MGA/J)</option>
				<option value="couple">VIP (100.000 MGA/J)</option>
            </select><br>
