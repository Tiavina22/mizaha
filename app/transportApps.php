   ...
   <div class="headerApp">
      ...
      <div class="left">
            ...
            <div>
               ...
               <div class="btn">
                  ...
                  <a href="transportApps.php" class="bindTransport" style="margin-left: 29px;color:white;font-family: poppinsBold;border-bottom: 4px solid #1ED760;">Agence de transport</a>
               </div>
               <div class="btn">
      ...
      <div class="centre">
         ...
         <div class="centreTop">
            <div class="logoSection">
               <i class="fa fa-truck fa-2x"></i>
               <p style="font-family: poppinsBold; margin-left: 10px;border-bottom: 4px solid #1ED760;">Agence de transport</p>
         ...
         <div class="home" id="home" style="overflow-x: hidden;">
         	<div>
         	<h1 class="texteBienvenue">Choisissez l'agence de transport que vous voulez <br> <?php echo " <span style='color:#1ED760;font-family:poppinsBold;font-size:30px;margin-left:5px;'>$nomUtilisateur</span>!";?></h1>
         	</div>
	         <div class="endroitPopulaire" id="started" style="margin-top:50px;margin-left: 0px; font-family:">
	         	<p style="font-family:poppinsBold;margin-left: 40px;">Tous les agences de transport disponnibles</p>
	...
	if ($resultat->num_rows > 0) {
		...
		while ($row = $resultat->fetch_assoc()){
			...
			echo "<a href='transportsDetails.php?id=$transportId' class='endroit-card' style='width:16%;margin-left:15px;background-color:#181818;border-radius:15px;padding:10px;margin-top:10px;'>";
			echo '<div>';
